...
from jericho.domain.scene_compiler import compile_scene_graph
from jericho.domain.narrative_compiler import compile_narrative
from jericho.domain.directive_planner import plan_directives
from jericho.domain.reasoning_strip import build_reasoning_strip
from jericho.domain.reasoning_chain import build_reasoning_chain
from jericho.domain.multi_goal_evaluator import evaluate_multi_goal_portfolio
from jericho.domain.integrity_deviation_engine import analyze_integrity_deviations
from jericho.domain.ai_session import build_session_snapshot
from jericho.domain.team_roles import filter_session_for_viewer
from jericho.domain.llm_contract import get_llm_contract
...
async def ai_command(payload: CommandPayload) -> JSONResponse:
    from jericho.domain.ai_interpreter import interpret_command
