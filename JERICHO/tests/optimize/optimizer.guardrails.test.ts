...
const baseline = [
  { actionId: 'm1', chunkIndex: 0, chunkCount: 1, dayKey: '2026-01-01', startMin: 540, durationMin: 60, category: 'focus', isMilestone: true },
  { actionId: 'x1', chunkIndex: 0, chunkCount: 1, dayKey: '2026-01-01', startMin: 600, durationMin: 60, category: 'creation' },
];

const candidateWorseMilestone = [
  { actionId: 'm1', chunkIndex: 0, chunkCount: 1, dayKey: '2026-01-03', startMin: 540, durationMin: 60, category: 'focus', isMilestone: true },
  { actionId: 'x1', chunkIndex: 0, chunkCount: 1, dayKey: '2026-01-01', startMin: 600, durationMin: 60, category: 'creation' },
];
